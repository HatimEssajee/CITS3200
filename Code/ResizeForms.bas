Attribute VB_Name = "ResizeForms"
Option Explicit

'SOURCE: https://exceloffthegrid.com/resize-a-userform-with-vba-or-windows-api/
...
'PURPOSE: enable dynamic resizing of window after load
'SOURCE: https://exceloffthegrid.com/resize-a-userform-with-vba-or-windows-api/
